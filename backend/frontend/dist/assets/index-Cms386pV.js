...
const Bath = createLucideIcon("bath", __iconNode$a);
/**
 * @license lucide-react v0.484.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const castleEmblem = "/assets/castle-emblem-Bsa1UMz4.svg";
function Hero() {
  const phoneNumber = "941-447-9191";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative bg-gradient-to-br from-[#0A0A0A] via-[#1a1a1a] to-[#0A0A0A] text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-16 md:py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-xl md:text-2xl text-[#F2F2F2] font-light", children: "Interior & Exterior Remodeling, Painting, Tile & Pressure Washing" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-[#F94144] font-semibold", children: "Insured & Bonded" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[#F2F2F2] text-sm", children: "Serving Sarasota & Manatee County" }) })
  ] }) }) });
}
const services = [
  { icon: House, label: "Interior Remodeling" },
  { icon: House, label: "Exterior Remodeling" },
...
function Services() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 md:py-24 bg-[#F2F2F2]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-michroma text-3xl md:text-4xl font-bold text-[#0A0A0A] mb-4", children: "Our Services" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-lg text-[#4A4A4A] max-w-2xl mx-auto", children: "Professional craftsmanship for all your home improvement needs" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8", children: services.map((service, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow text-center",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(service.icon, { className: "h-10 w-10 mx-auto mb-4 text-[#D62828]" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-sm md:text-base font-medium text-[#0A0A0A]", children: service.label })
        ]
      },
      index2
    )) })
...
function Gallery() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 md:py-24 bg-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-michroma text-3xl md:text-4xl font-bold text-[#0A0A0A] mb-4", children: "Our Work" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-lg text-[#4A4A4A] max-w-2xl mx-auto", children: "See the quality and craftsmanship that sets us apart" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: photos.map((photo, index2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "group relative overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow bg-[#F2F2F2]",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square bg-gradient-to-br from-[#4A4A4A] to-[#0A0A0A] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-michroma text-white text-sm mb-2", children: photo.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-[#F2F2F2] text-xs", children: photo.description })
        ] }) })
      },
      index2
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center mt-8 font-inter text-sm text-[#4A4A4A] italic", children: "Replace these placeholders with actual project photos" })
  ] }) }) });
}
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 md:py-24 bg-[#0A0A0A] text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center mb-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-michroma text-3xl md:text-4xl font-bold mb-4", children: "About Castle's Custom Painting & Tile" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-8 mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-12 w-12 mx-auto mb-4 text-[#D62828]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-michroma text-lg font-bold mb-2", children: "Insured & Bonded" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-sm text-[#F2F2F2]", children: "Full insurance coverage for your peace of mind" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { className: "h-12 w-12 mx-auto mb-4 text-[#D62828]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-michroma text-lg font-bold mb-2", children: "Expert Craftsmanship" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-sm text-[#F2F2F2]", children: "Years of experience delivering quality results" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-12 w-12 mx-auto mb-4 text-[#D62828]" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-michroma text-lg font-bold mb-2", children: "Locally Owned" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-sm text-[#F2F2F2]", children: "Proud to serve Sarasota & Manatee, Tampa & St. Petersburg" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-inter text-center text-[#F2F2F2] space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg", children: "Castle's Custom Painting & Tile, Inc. is your trusted partner for all interior and exterior home improvement projects. Led by Chris, our team brings professional expertise and attention to detail to every job." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "From complete bathroom remodels to exterior pressure washing, we deliver exceptional results that transform your home. We're fully insured and bonded, ensuring your property is protected throughout every project." })
    ] })
  ] }) }) });
}
...
((contact2) => {
  class ServiceClient {
    ...
    async list() {
      const resp = await this.baseClient.callTypedAPI(`/contact/list`, { method: "GET", body: void 0 });
  ...
  contact2.ServiceClient = ServiceClient;
})(contact || (contact = {}));
...
const backend = new Client(getBaseURL(), { requestInit: { credentials: "include" } });
function ContactForm() {
  ...
  const backend2 = new Client(Local);
  const handleSubmit = async (e) => {
    e.preventDefault();
    setIsSubmitting(true);
    try {
      const response = await backend2.contact.submit(formData);
      if (response.success) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-16 md:py-24 bg-[#F2F2F2]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-3xl md:text-4xl text-[#0A0A0A] mb-4", children: "Request Your Free Estimate" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-[#4A4A4A]", children: "Tell us about your project and we'll get back to you promptly" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "bg-white p-8 rounded-lg shadow-md space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "name", className: "font-medium", children: "Name *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "name",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "phone", className: "font-medium", children: "Phone *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "phone",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "email", className: "font-medium", children: "Email *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "email",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "projectType", className: "font-medium", children: "Type of Project *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "interior-remodel", children: "Interior Remodeling" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "exterior-remodel", children: "Exterior Remodeling" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "interior-painting", children: "Interior Painting" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "exterior-painting", children: "Exterior Painting" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "bathroom-remodel", children: "Bathroom Remodeling" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "tile-installation", children: "Tile Installation" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "pressure-washing", children: "Pressure Washing" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "message", className: "font-medium", children: "Message" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Textarea,
          {
            id: "message",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          size: "lg",
          children: isSubmitting ? "Submitting..." : "Request Free Estimate"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-600", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-[#D62828]", children: "(941) 447-9191" })
    ] }) })
  ] }) }) });
}
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[#0A0A0A] text-white py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-8 mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-michroma text-xl font-bold mb-4 text-[#D62828]", children: "CASTLE'S Custom Painting & Tile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-sm text-[#F2F2F2]", children: "Professional interior & exterior remodeling, painting, tile installation, and pressure washing services." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-sm text-[#F94144] mt-2 font-semibold", children: "Insured & Bonded" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-michroma text-lg font-bold mb-4", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 font-inter text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: `tel:${phoneNumber}`,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-michroma text-lg font-bold mb-4", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 font-inter text-sm text-[#F2F2F2]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Interior & Exterior Remodeling" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Interior & Exterior Painting" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Bathroom Remodeling" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Tile Installation" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Pressure Washing" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-[#4A4A4A] pt-8 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-inter text-sm text-[#F2F2F2]", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Castle's Custom Painting & Tile, Inc. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-inter text-xs text-[#4A4A4A] mt-2", children: "Serving Sarasota & Manatee County, Florida" })
    ] })
  ] }) }) });
}
function AdminDashboard() {
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-[#D62828] mx-auto" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-gray-600", children: "Loading submissions..." })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 py-8 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-bold text-gray-900 mb-2", children: "Contact Form Submissions" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white shadow-md rounded-lg overflow-hidden", children: submissions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12 text-gray-500", children: "No contact submissions yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Project Type" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider", children: "Message" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: submissions.map((submission) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "hover:bg-gray-50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap text-sm text-gray-500", children: formatDate(submission.created_at) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-6 py-4 whitespace-nowrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-900", children: submission.phone }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-gray-500", children: submission.email })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 whitespace-nowrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800", children: getProjectTypeLabel(submission.project_type) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 text-sm text-gray-500 max-w-xs", children: submission.message || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic text-gray-400", children: "No message" }) })
      ] }, submission.id)) })
    ] }) }) }),
...
function AdminPage() {
  ...
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-[#0A0A0A] via-[#1a1a1a] to-[#0A0A0A] flex items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg shadow-xl p-8 max-w-md w-full", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900 mb-6 text-center", children: "Admin Login" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm text-gray-500 text-center", children: "Default password: castle2024" })
    ] }) });
  }
