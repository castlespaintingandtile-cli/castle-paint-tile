...
```bash
git remote add encore encore://castles-painting-tile-landing-page-ig52
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/castles-painting-tile-landing-page-ig52/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/castles-painting-tile-landing-page-ig52/settings/integrations/github)
